!(function () {
  ...
  function a(e) {
    ...
    return function () {
      ...
      return (t = s) &&
        ("object" == (t && t.constructor === Symbol ? "symbol" : typeof t) ||
          "function" == typeof t)
        ? t
        : (function (e) {
            if (void 0 === e)
  ...
  var l = "https://cdn.jsdelivr.net/pyodide/v0.21.0/full/",
    r = (function () {
      function n() {
        e(this, n);
      }
        ...
        t(n, null, [
          {
            key: "create",
            value: function () {
              return self.sessionStorage ? new u() : new d();
            },
          },
        ]),
        n
    ...
    d = (function (n) {
      ...
      function o() {
        var n;
        return e(this, o), ((n = s.call(this)).fs = {}), n;
      }
      return (
        t(o, [
          {
    ...
    u = (function (n) {
      ...
      var s = a(o);
      function o() {
        return e(this, o), s.apply(this, arguments);
      }
      return (
        t(o, [
          {
    ...
    c = (function () {
      function n(t) {
        e(this, n),
          (this.pyodide = null),
          (this.postExec = (t && t.postExec) || function () {}),
          (this.write = (t && t.write) || function (e) {}),
          (this.clearText = (t && t.clearText) || function () {}),
          (this.setFigureURL = (t && t.setFigureURL) || function (e) {}),
          (this.notifyDirtyFile = (t && t.notifyDirtyFile) || function (e) {}),
          (this.notifyStatus = (t && t.notifyStatus) || function (e) {}),
          (this.handleInput = (t && t.handleInput) || !1),
          (this.inlineInput = (t && t.inlineInput) || !1),
          (this.pyodideURL = (t && t.pyodideURL) || l);
        var s = /\/(v[\d.]+)\//.exec(this.pyodideURL);
        (this.pyodideVersion = s ? s[1] : ""),
          (this.requestInput = !1),
          (this.inputPrompt = null),
          (this.suspended = !1),
          (this.dbgCurrentLine = null),
          (this.preLoadedPackages = null == t ? void 0 : t.preLoadedPackages),
                          ...
                          n.pyodide
                            ...
                            .catch(function (t) {
                              n.failedModuleNames.push(e),
                                n.notifyStatus("error pre-loading " + e + t);
                            });
                      }),
                      n.pyodide.runPython(
            ...
            value: function (e, n) {
                ...
                if (
                  ...
                  return (
                    ...
                    this.pyodide
                      ...
                      .catch(function () {
                        t.failedModuleNames.push(o), t.postExec && t.postExec();
                      }),
                    !1
                  );
                }
              ...
              return (
                ...
                this.pyodide.globals.get("done") ||
                  ...
                  !this.inlineInput ||
                  this.write(
                    void 0 == this.inputPrompt ? "? " : this.inputPrompt
                  ),
            ...
            value: function (e) {
              ...
              try {
                (self.dbg_command = e),
                  ...
                  (this.suspended = this.pyodide.globals.get("suspended")),
                  (this.requestInput = 2 == this.pyodide.globals.get("status")),
                  (this.inputPrompt = null);
              } catch (e) {}
  ...
  importScripts("".concat(l, "pyodide.js"));
  var p = !1,
    f = !1,
    g = "",
    h = -1,
        ...
        var n = {
          ...
          postExec: function () {
            ...
            (h = e = Date.now()) < 0
              ? (h = e + 10)
              : h <= e &&
                (f && (postMessage({ cmd: "clear" }), (f = !1)),
                g && (postMessage({ cmd: "print", data: g }), (g = "")),
                (h = -1)),
              postMessage({
                cmd: "done",
                suspendedAt: m.suspended ? m.dbgCurrentLine : null,
              }),
              m.requestInput &&
                postMessage({ cmd: "input", prompt: m.inputPrompt });
          },
          handleInput: (e && e.handleInput) || !1,
          inlineInput: (e && e.inlineInput) || !1,
          preLoadedPackages: (null == e ? void 0 : e.preLoadedPackages) || [],
          pyodideURL: l,
        };
        console.log("options inside worker: ", n), (m = new c(n));
      },
      s = JSON.parse(e.data);
    if ("config" === s.cmd) t(s.options);
    else
      switch ((null == m && t(), s.cmd)) {
        case "preload":
          postMessage({ cmd: "status", status: "startup" }),
            m.load(function () {
              (p = !0), postMessage({ cmd: "done" });
            });
          break;
        case "run":
          p
            ? _(s.code, s.breakpoints)
            : (postMessage({ cmd: "status", status: "startup" }),
              m.load(function () {
                _(s.code, s.breakpoints), (p = !0);
              }));
          break;
        case "submit":
          (n = s.str), m.submitInput(n, void 0);
          break;
        case "cancel":
          m.cancelInput();
          break;
        ...
        case "get":
          postMessage({
            cmd: "file",
            path: s.path,
            data: m.fs.getFile(s.path),
          });
          break;
        case "put":
          m.fs.setFile(s.path, s.data);
          break;
        case "clearFigure":
          m.clearFigure();
      }
