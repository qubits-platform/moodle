...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [437],
  {
    3437: function (e, n, t) {
      ...
      var I =
          ((s = (0, d.Z)(function (e, n) {
            var t, s, i, o;
            return (0, p.__generator)(this, function (a) {
              switch (a.label) {
                case 0:
                  return console.log(e), [4, Z()];
                case 1:
                  return (
                    (t = new (a.sent().oo1.DB)("/data.db", "cw")),
                    (s = function () {
                      try {
                        e.split("\n").forEach(function (e) {
                          if (!e.startsWith("--")) {
                            var s = e.split(/\s/).slice(0, 1)[0].toLowerCase();
                            if ("create" == s) {
                              t.exec(e);
                              var i = "created Table successfully";
                              console.log(
                                void 0 === i ? "undefined" : (0, N.Z)(i)
                              ),
                                n(i);
                            } else if ("insert" == s)
                              t.exec(e), n("Inserted Data Successfully");
                            else if ("select" == s) {
                              var o = [],
                                a = [];
                              t.exec({
                              ...
                              var l = "<span>"
                                ...
                                .replace(/undefined/g, "");
                              n(l);
                            } else "delete" == s && t.exec(e);
                          }
                        });
                      } catch (e) {
                        for (
                          var s = e.message.split(":"), i = "", o = 0;
                          o < s.length;
                          o++
                        )
                          i += s[o];
                    ...
                    i.startsWith("--")
                      ? ((o = i.split(":")[1].trim()),
                        F("./".concat(o), {
                          ...
                          .catch(function (e) {
                            return alert(
                              "Unable to load data file: " + e.message
                            );
                          }))
                      : s(),
                    [2]
                ...
                case 0:
                  ...
                  return [
                    ...
                    new Promise(function (e) {
                      ...
                      if (!j)
                        throw Error(
                          "Sqlite didnt initialize.. reload your browser and try"
                        );
                      return j;
                    }),
                  ];
          ...
          ((a = (0, d.Z)(function (e, n, t) {
            ...
            return (0, p.__generator)(this, function (a) {
              switch (a.label) {
                ...
                case 2:
                  return (
                    a.trys.push([2, 5, , 6]), [4, s.loadPackagesFromImports(e)]
                  );
                case 3:
                  return (i = a.sent()), [4, s.runPythonAsync(e)];
                case 4:
                  return (
                    (i = a.sent()) ? E(i, n) : "" !== P ? E(i, n) : n(""),
                    t(!0),
                    [3, 6]
                  );
                case 5:
                  return (o = a.sent()), t(!0), L(o.message, n), [3, 6];
                case 6:
                  return [2];
              }
            });
      ...
      var A =
          ((r = (0, d.Z)(function (e, n, t) {
            return (0, p.__generator)(this, function (s) {
              return T(e, n, t), [2];
            });
          })),
          function (e, n, t) {
          ...
          ((l = (0, d.Z)(function (e, n, t) {
            ...
            return (0, p.__generator)(this, function (o) {
              switch (o.label) {
                ...
                case 1:
                  return [4, (s = o.sent()).loadPackage("micropip")];
                case 2:
                  return (
                    o.sent(),
                    [
                      ...
                      s
                        .pyimport("micropip")
                        .install(
                          "https://cdn.jsdelivr.net/gh/qubits-platform/pytutor@master/dist/pytutor-1.0.0-py3-none-any.whl"
                        ),
                    ]
                  );
                case 3:
                ...
                case 4:
                  return (i = o.sent()) && (t(""), n(JSON.parse(i))), [3, 6];
                case 5:
                  return console.log(o.sent()), [3, 6];
                case 6:
                  return [2];
              }
            });
      ...
      function D(e) {
        var n = e.content,
          t = e.language,
          s = t ? q.Z.highlight(t, n) : q.Z.highlightAuto(n);
        return (0, f.jsx)("pre", {
          className: "hljs",
          children: (0, f.jsx)("code", {
            className: "language-".concat(t, " hljs"),
      ...
      var B = t(1438),
            ...
            (0, G.Z)(e, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.stop();
                  try {
                    this.worker = new Worker(t.tu(new URL(t.p + t.u(70), t.b)));
                  } catch (e) {
                    console.log(e);
                    var n,
                      s = "data://application/javascript,".concat(
                        ((n = this.workerURL),
                  ...
                  (this.isRunning = !1),
                    this.worker.addEventListener("message", function (n) {
                      var t, s, i, o, a, r, l, u;
                      switch (n.data.cmd) {
                        case "print":
                          e.printToOutput(n.data.data);
                          break;
                        case "clear":
                          e.clearOutput();
                          break;
                        case "figure":
                          null === (t = e.onFigure) ||
                            void 0 === t ||
                            t.call(e, n.data.data);
                          break;
                        case "dirty":
                          null === (s = e.onDirtyFile) ||
                            void 0 === s ||
                            s.call(e, n.data.data);
                          break;
                        case "file":
                          null === (i = e.onReceivePyFile) ||
                            void 0 === i ||
                            i.call(e, n.data.path, n.data.data);
                          break;
                        case "input":
                          (e.isRunning = !1),
                            (e.webworkerStatus = "input"),
                            null === (o = e.onStatusChanged) ||
                              void 0 === o ||
                              o.call(e, "input"),
                            null === (a = e.onInput) ||
                              void 0 === a ||
                              a.call(e, n.data.prompt);
                          break;
                        case "status":
                          (e.webworkerStatus = n.data.status),
                            null === (r = e.onStatusChanged) ||
                              void 0 === r ||
                              r.call(e, e.webworkerStatus);
                          break;
                        case "done":
                          (e.isRunning = !1),
                            (e.isSuspended = null != n.data.suspendedAt),
                            (e.dbgCurrentLine = n.data.suspendedAt),
                            (e.webworkerStatus = "idle"),
                            null === (l = e.onStatusChanged) ||
                              void 0 === l ||
                              l.call(e, "done"),
                            null === (u = e.onTerminated) ||
                              void 0 === u ||
                              u.call(e);
                          break;
                        default:
                          "cmd:" === n.data.cmd.slice(0, 4) &&
                            e.commands[n.data.cmd.slice(4)] &&
                            e.commands[n.data.cmd.slice(4)](n.data.data);
                      }
                    }),
                    this.worker.addEventListener("error", function (n) {
                      e.onError ? e.onError(n) : console.info(n);
                    });
                  var i = {
                    cmd: "config",
                    options: {
                  ...
                  console.log(
                    "preloaded packages in PyWorker: ",
                    this.preLoadedPackages
                  ),
                    this.worker.postMessage(JSON.stringify(i));
                },
              },
              {
                key: "handleTimeout",
                value: function () {
                  ...
                  this.maxTimeout >= 0 &&
                    ...
                    (this.timeoutId = setTimeout(function () {
                      e.isRunning &&
                        (e.stop(),
                        e.onStatusChanged && e.onStatusChanged("timeout"),
                ...
                value: function (e) {
                  var n =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ? arguments[1]
                      : [];
                  (null == this.worker || this.isRunning) && this.create(),
                    this.worker.postMessage(
                      JSON.stringify(
                        null != e
                          ? { cmd: "run", code: e, breakpoints: n }
                          : { cmd: "preload" }
                      )
                    ),
                    (this.isRunning = !0),
              ...
              },
              {
                ...
                value: function (e) {
                  this.worker &&
                    !this.isRunning &&
                    (this.worker.postMessage(
                      JSON.stringify({ cmd: "submit", str: e })
                    ),
                    (this.isRunning = !0),
                    this.handleTimeout());
                },
              },
              {
                ...
                value: function () {
                  this.worker &&
                    !this.isRunning &&
                    (this.worker.postMessage(JSON.stringify({ cmd: "cancel" })),
              ...
              },
              {
                ...
                value: function (e) {
                  this.worker &&
                    this.isSuspended &&
                    (this.worker.postMessage(
                      JSON.stringify({ cmd: "debug", dbg: e })
                    ),
                    (this.isRunning = !0),
                    this.handleTimeout());
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  null === (n = this.worker) ||
                    void 0 === n ||
                    n.postMessage(JSON.stringify({ cmd: "get", path: e }));
                },
              },
              {
                key: "putFile",
                value: function (e, n) {
                  ...
                  null === (t = this.worker) ||
                    void 0 === t ||
                    t.postMessage(
                      JSON.stringify({ cmd: "put", path: e, data: n })
                    );
                },
              },
              {
              ...
              },
              {
                key: "clearOutput",
                value: function () {
                  this.sharedOutput || (this.outputBuffer = ""),
                    this.onOutput && this.onOutput("", !1);
                },
              },
              {
                key: "clearFigure",
                value: function () {
                  ...
                  null === (e = this.worker) ||
                    void 0 === e ||
                    e.postMessage(JSON.stringify({ cmd: "clearFigure" }));
                },
              },
              {
                key: "printToOutput",
                value: function (e) {
                  this.sharedOutput
                    ? this.onOutput && this.onOutput(e, !0)
                    : ((this.outputBuffer += e),
                      this.onOutput && this.onOutput(this.outputBuffer, !1));
                },
              },
            ]),
            e
        ...
        z = (0, t(948).ZP)("textarea")(function (e) {
          return (
            e.theme,
            {
        ...
        V = function (e) {
            ...
            function () {
              l(o),
                (null == u ? void 0 : u.current) &&
                  ...
                  u.current.focus(),
                  u.current.setSelectionRange(n.length, n.length));
            },
            [n, t]
          );
          var o = "",
            a = (0, c.Z)((0, h.useState)(o), 2),
            r = a[0],
            l = a[1],
            u = (0, h.useRef)(null),
            d = (0, h.useRef)(null);
          return (0, f.jsx)("div", {
            ...
            children: (0, f.jsx)(z, {
              ...
              ref: u,
              onChange: function (e) {
                l(e.target.value.slice(n.length));
              },
              onKeyDown: function (e) {
                "Enter" === e.key && (l(o), s(r), i(""));
              },
        ...
        Q = h.forwardRef(function (e, n) {
          return (0,
          f.jsx)(H.Z, (0, K.Z)({ elevation: 6, ref: n, variant: "filled" }, e));
        }),
        $ = t(6422),
        X = t(6485),
        ee = X.Configuration,
        ...
        et = function (e) {
          var n,
            ...
            s = e.code,
            i = e.getHints,
            o = e.getDebuggerStatus,
            a = e.getLog,
            r = e.IsErrorCatch,
            l = new ee({
              apiKey: "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",
            }),
            u = new en(l),
            c =
              ((n = (0, d.Z)(function (e, n) {
                var t, s, l, d;
                return (0, p.__generator)(this, function (c) {
                  switch (c.label) {
                        ...
                        (l = [
                          {
                            role: "system",
                            content:
                              "You are helping a student who is in 8th grade who is trying to learn programming",
                          },
                          {
                            role: "user",
                            content:
                    ...
                    case 2:
                      return (
                        i(JSON.parse(c.sent().data.choices[0].message.content)),
                        o("done"),
                        [3, 4]
                      );
                    case 3:
                      return (
                        (d = c.sent()),
                        r(!1),
                        a(d.response.data.error.message),
                        [3, 4]
                      );
                    case 4:
                      return [2];
      ...
      function es(e) {
        var n,
          ...
          N = e.visualization,
          j = e.reset,
          F = (0, c.Z)((0, h.useState)(null), 2),
          Z = F[0],
          P = F[1],
          C = (0, c.Z)((0, h.useState)(""), 2),
          O = C[0],
          T = C[1],
          L = (0, c.Z)((0, h.useState)(!1), 2),
          E = L[0],
          M = L[1],
          q = (0, c.Z)((0, h.useState)(!1), 2),
          B = q[0],
          G = q[1];
        (0, h.useEffect)(
          function () {
        ...
        var z = function (e) {
            Z.run(e), Z.clearOutput(), G(!0);
          },
          K = (0, c.Z)((0, h.useState)(""), 2),
          H = K[0],
          $ = K[1],
          X = (0, c.Z)((0, h.useState)(""), 2),
          ee = X[0],
          en = X[1],
          es = (0, c.Z)((0, h.useState)(!1), 2),
          ei = es[0],
          eo = es[1],
          ea = (0, c.Z)((0, h.useState)(!1), 2),
          er = ea[0],
          el = ea[1],
          eu = (0, c.Z)((0, h.useState)(!1), 2),
          ed = eu[0],
          ec = eu[1],
          ep = (0, c.Z)((0, h.useState)(""), 2),
          ef = ep[0],
          eh = ep[1],
          eg = (0, c.Z)((0, h.useState)(!1), 2),
          em = eg[0],
          eb = eg[1],
          ey = (0, c.Z)((0, h.useState)(!1), 2),
          e_ = ey[0],
          ev = ey[1],
          ek = (0, c.Z)((0, h.useState)(""), 2),
          ex = ek[0],
          ew = ek[1],
          eS = (0, c.Z)((0, h.useState)(), 2),
          eN = eS[0],
          ej = eS[1],
          eI = (0, c.Z)((0, h.useState)(!1), 2),
          eF = eI[0],
          eZ = eI[1],
          eP = (0, c.Z)((0, h.useState)(!0), 2),
          eC = eP[0],
          eO = eP[1],
          eT =
            ((n = (0, d.Z)(function (e, n) {
        ...
        (0, h.useEffect)(
          function () {
            var e, n, t, s;
            !ee ||
            (null === (e = ee.trace) || void 0 === e
              ? void 0
              : e[0].exception_msg)
              ? ee &&
                (null === (n = ee.trace) || void 0 === n
                  ? void 0
                  : n[0].exception_msg) &&
                (eo(!1),
                ew(
                  null === (s = ee.trace) || void 0 === s
                    ? void 0
                    : s[0].exception_msg
                ),
                ev(!0))
              : ((t = new ExecutionVisualizer("TraceBlock" + r, ee, {
                  debugMode: !1,
                  showAllFrameLabels: !0,
                  lang: "py3",
                  highlightLines: !0,
                  arrowLines: !1,
                  verticalStack: !0,
          ...
          (0, h.useEffect)(
            function () {
              H && H.search("Traceback") && el(!0);
            },
            [H]
          ),
          (0, h.useEffect)(function () {}, [ef]);
        var eE = function () {
            return (0, f.jsx)(g.Z, {
              sx: {
                display: "flex",
        ...
        return (0, f.jsxs)("div", {
          ...
          children: [
            ...
            a && (0, f.jsx)(D, { language: o, content: i }),
            (0, f.jsx)(g.Z, {
              spacing: 3,
              ...
              children: (0, f.jsxs)(m.Z, {
                ...
                children: [
                  (0, f.jsx)(b.Z, {
                    title: (0, f.jsx)(y.Z, { fontSize: 12, children: "Run" }),
                    placement: "top",
                    children: (0, f.jsx)(_.Z, {
                      variant: "outlined",
                      endIcon: (0, f.jsx)(k.Z, {}),
                    ...
                    (0, f.jsx)(et, {
                      ...
                      getHints: function (e) {
                        e &&
                          ...
                          ej(
                            e.hints
                              .slice(0, e.hints.lastIndexOf("."))
                              .split(".")
                          ),
                          eh(e));
                      },
                      getDebuggerStatus: function (e) {
                        "loading" === e
                          ? (eh(""), ec(!0))
                          : "done" === e && eo(!1);
                      },
                      getLog: function (e) {
                        ew(
                          "Error Occurred while trying to get hints. Please retry"
                        ),
                          ev(!0);
                      },
                      setShowAIDebugBtn: eZ,
                      IsErrorCatch: eO,
                    }),
                  (0, f.jsx)("code", {
                    className: "resultTextareaStyle w-100",
            ...
            ed &&
              (0, f.jsx)(f.Fragment, {
                children: ef.hints
                  ? (0, f.jsx)("div", {
                      className: "ai-console-wrapper",
                      children: (0, f.jsxs)("div", {
                        className: "resultTextareaStyleerror",
                        children: [
                          " ",
                          (0, f.jsx)(_.Z, {
                            variant: "outlined",
            ...
            ee &&
              ...
              (0, f.jsx)("div", {
                id: "TraceBlock" + r,
                className: "traceBlockStyle w-100",
              }),
            ei && (0, f.jsx)(eE, {}),
            ee && (0, f.jsx)("div", { id: "TraceBlock" + r }),
            (0, f.jsx)(W.Z, {
              in: e_,
              sx: { mt: 2 },
              children: (0, f.jsx)(Q, {
    ...
    2135: function (e, n, t) {
      ...
      var s = t(1438),
        ...
        a = t(1357),
        r = t(6296),
        l = "https://cdn.jsdelivr.net/pyodide/v0.21.3/full/",
        u = (function () {
          function e() {
            (0, s.Z)(this, e);
          }
            ...
            (0, i.Z)(e, null, [
              {
                key: "create",
                value: function () {
                  return self.sessionStorage ? new c() : new d();
                },
              },
            ]),
            e
        ...
        d = (function (e) {
          ...
          function t() {
            var e;
            return (0, s.Z)(this, t), ((e = n.call(this)).fs = {}), (0, a.Z)(e);
          }
          return (
            (0, i.Z)(t, [
              {
        ...
        c = (function (e) {
          ...
          var n = (0, r.Z)(t);
          function t() {
            return (0, s.Z)(this, t), n.apply(this, arguments);
          }
          return (
            (0, i.Z)(t, [
              {
              ...
              },
              {
                key: "getFile",
                value: function (e) {
                  return self.sessionStorage.getItem(e);
                },
              },
              {
                key: "setFile",
                value: function (e, n) {
                  self.sessionStorage.setItem(e, n);
                },
              },
            ]),
            t
        ...
        p = (function () {
          function e(n) {
            (0, s.Z)(this, e),
              (this.pyodide = null),
              (this.postExec = (n && n.postExec) || function () {}),
              (this.write = (n && n.write) || function (e) {}),
              (this.clearText = (n && n.clearText) || function () {}),
              (this.setFigureURL = (n && n.setFigureURL) || function (e) {}),
              (this.notifyDirtyFile =
                (n && n.notifyDirtyFile) || function (e) {}),
              (this.notifyStatus = (n && n.notifyStatus) || function (e) {}),
              (this.handleInput = (n && n.handleInput) || !1),
              (this.inlineInput = (n && n.inlineInput) || !1),
              (this.pyodideURL = (n && n.pyodideURL) || l);
            var t = /\/(v[\d.]+)\//.exec(this.pyodideURL);
            (this.pyodideVersion = t ? t[1] : ""),
              (this.requestInput = !1),
              (this.inputPrompt = null),
              (this.suspended = !1),
              (this.dbgCurrentLine = null),
              (this.preLoadedPackages =
                null == n ? void 0 : n.preLoadedPackages),
            ...
            (0, i.Z)(e, [
              {
                ...
                value: function (e) {
                  ...
                  this.notifyStatus("loading Pyodide " + this.pyodideVersion),
                    globalThis
                      .loadPyodide({ indexURL: this.pyodideURL })
                      .then(function (t) {
                        (n.pyodide = t),
                          (n.pyodideVersion = t.version),
                          n.notifyStatus("setup"),
                          (self.pyodideGlobal = {
                            requestModule: function (e) {
                              return n.requestModule(e);
                            },
                            fs: n.fs,
                            markFileDirty: function (e) {
                              return n.markFileDirty(e);
                            },
                            setDbgCurrentLine: function (e) {
                              n.dbgCurrentLine = e;
                            },
                          }),
                          n.preLoadedPackages.forEach(function (e) {
                            n.notifyStatus("pre-loading " + e),
                              n.pyodide
                                .loadPackage(e)
                                .then(function () {
                                  n.loadedModuleNames.push(e),
                                    n.notifyStatus(e + " pre-loaded");
                                })
                                .catch(function (t) {
                                  n.failedModuleNames.push(e),
                                    n.notifyStatus(
                                      "error pre-loading " + e + t
                                    );
                                });
                          }),
                          n.pyodide.runPython(
              ...
              },
              {
                key: "requestModule",
                value: function (e) {
                  0 > this.requestedModuleNames.indexOf(e) &&
                    0 > this.loadedModuleNames.indexOf(e) &&
                    0 > this.failedModuleNames.indexOf(e) &&
                    this.requestedModuleNames.push(e);
                },
              },
              {
                key: "markFileDirty",
                value: function (e) {
                  0 > this.dirtyFiles.indexOf(e) &&
                    (this.dirtyFiles.push(e), this.notifyDirtyFile(e));
                },
              },
              {
                key: "getDirtyFilePaths",
                value: function (e) {
                  var n = this.dirtyFiles;
                  return e && (this.dirtyFiles = []), n;
                },
              },
              {
                key: "run",
                value: function (e, n) {
                  ...
                  this.pyodide.runPython(
                    ...
                    this.loadedModuleNames.indexOf("matplotlib") >= 0 &&
                      this.pyodide.runPython(
                        '\n                import matplotlib\n                matplotlib.use("Agg")\n            '
                      ),
                    this.handleInput &&
                  ...
                  try {
                    if (
                      ...
                      (self.pyodideGlobal.setFigureURL = function (e) {
                        return t.setFigureURL(e);
                      }),
                      this.pyodide.globals.set("src", e),
                      n && n.length > 0)
                    ) {
                      var i =
                        "[" +
                        ...
                        "]";
                      this.pyodide.runPython(
                        "\n                    import js\n                    status = execute_code(src, breakpoints=".concat(
                          i,
                        ...
                        (this.requestInput =
                          2 === this.pyodide.globals.get("status")),
                        (this.inputPrompt = null);
                    } else
                      this.handleInput
                        ? (this.pyodide.runPython(
                          ...
                          this.pyodide.globals.get("done") ||
                            this.pyodide.globals.get("suspended") ||
                            ((this.inputPrompt =
                              this.pyodide.globals.get("input_prompt")),
                            (this.requestInput = !0)))
                        : this.pyodide.runPython(
                    ...
                    if (
                      /ModuleNotFoundError/.test(n.message) &&
                      this.requestedModuleNames.length > 0
                    ) {
                      var o = this.requestedModuleNames.shift();
                      return (
                        this.notifyStatus("loading module " + o),
                        this.pyodide
                          .loadPackage(o)
                          .then(function () {
                            t.loadedModuleNames.push(o),
                              t.notifyStatus("running"),
                              t.run(e);
                          })
                          .catch(function () {
                            t.failedModuleNames.push(o),
                              t.postExec && t.postExec();
                          }),
                        !1
                      );
                    }
                    (s = n.message), this.pyodide.globals.set("done", !0);
                  }
                  var a = this.pyodide.runPython("sys.stdout.getvalue()");
                  return (
                    this.write(a + s),
                    this.pyodide.globals.get("done") ||
                      this.pyodide.globals.get("suspended") ||
                      !this.inlineInput ||
                      this.write(
                        null == this.inputPrompt ? "? " : this.inputPrompt
                      ),
                  ...
                  if (this.requestInput) {
                    ...
                    if (this.suspended)
                      ...
                      try {
                        ...
                        (n = e.message), this.pyodide.globals.set("done", !0);
                      }
                    var t = this.pyodide.runPython("sys.stdout.getvalue()");
                    this.write(t + n),
                      this.pyodide.globals.get("done") ||
                        this.pyodide.globals.get("suspended") ||
                        !this.inlineInput ||
              ...
              {
                key: "continueDebugging",
                value: function (e) {
                  this.pyodide.runPython(
                    "import io, syssys.stdout = io.StringIO()sys.stderr = sys.stdout"
                  );
                  try {
                    (self.dbg_command = e),
                      this.pyodide.runPython(
                  ...
                  var n = this.pyodide.runPython("sys.stdout.getvalue()");
                  this.write(n),
                    this.pyodide.globals.get("done") ||
                      this.pyodide.globals.get("suspended") ||
                      !this.inlineInput ||
              ...
              },
              {
                key: "clear",
                value: function () {
                  this.clearText(), this.clearFigure();
                },
              },
            ]),
            e
      ...
      function y(e, n) {
        postMessage({
          cmd: "status",
          status: n && n.length > 0 ? "debugging" : "running",
        }),
          b.run(e, n);
      }
        ...
        var n,
          ...
          s = function (e) {
            var n = {
              ...
              setFigureURL: function (e) {
                postMessage({ cmd: "figure", data: e });
              },
              notifyStatus: function (e) {
                postMessage({ cmd: "status", status: e });
              },
              notifyDirtyFile: function (e) {
                postMessage({ cmd: "dirty", data: e });
              },
              postExec: function () {
                var e;
                (m = e = Date.now()) < 0
                  ? (m = e + 10)
                  : m <= e &&
                    (h && (postMessage({ cmd: "clear" }), (h = !1)),
                    g && (postMessage({ cmd: "print", data: g }), (g = "")),
                    (m = -1)),
                  postMessage({
                    cmd: "done",
                    suspendedAt: b.suspended ? b.dbgCurrentLine : null,
                  }),
                  b.requestInput &&
                    postMessage({ cmd: "input", prompt: b.inputPrompt });
              },
              handleInput: (e && e.handleInput) || !1,
              inlineInput: (e && e.inlineInput) || !1,
              preLoadedPackages:
                (null == e ? void 0 : e.preLoadedPackages) || [],
              pyodideURL: l,
            };
            console.log("options inside worker: ", n), (b = new p(n));
          },
          i = JSON.parse(e.data);
        if ("config" === i.cmd) s(i.options);
        else
          switch ((null == b && s(), i.cmd)) {
            case "preload":
              postMessage({ cmd: "status", status: "startup" }),
                b.load(function () {
                  (f = !0), postMessage({ cmd: "done" });
                });
              break;
            case "run":
              f
                ? y(i.code, i.breakpoints)
                : (postMessage({ cmd: "status", status: "startup" }),
                  b.load(function () {
                    y(i.code, i.breakpoints), (f = !0);
                  }));
              break;
            case "submit":
              (n = i.str), b.submitInput(n, t);
              break;
            case "cancel":
              b.cancelInput();
              break;
            case "debug":
              if (f && b.suspended)
                switch (i.dbg) {
                  ...
                  case "continue":
                  case "quit":
                    b.continueDebugging(i.dbg);
                }
              else postMessage({ cmd: "done" });
              break;
            case "get":
              postMessage({
                cmd: "file",
                path: i.path,
                data: b.fs.getFile(i.path),
              });
              break;
            case "put":
              b.fs.setFile(i.path, i.data);
              break;
            case "clearFigure":
              b.clearFigure();
          }
